...
import { ICreateResume, ILoginUser, createResume, getResume ,updateResume , login ,register, IUser, UserResponse} from '../api/apiServices';
...
const logout = () => {
  ...
  return (
    // <ApiContext.Provider value={apiMethods} >
      <ApiContext.Provider value={{...apiMethods,fetchResume,resumeInfo,setResumeInfo, updateResume, user,setUser, logout}}>
      {children}
    </ApiContext.Provider>
  );
};
